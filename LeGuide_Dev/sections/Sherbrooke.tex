...
\end{example}
 ...
 \begin{example}{Le délai est trop serré?}
...
\clearpage
 ...
 Voici le récapitulatif des documents à obtenir pour avoir le droit de partir.
 \begin{description}
   \item[$\bullet$]Acceptation de l'Université de Sherbrooke.
   \item[$\bullet$]Passport renouvelé ou assez récent.
   \item[$\bullet$]Certificat médical si soin permanent. (optionnel)
   ...
   \item[$\bullet$]Choix des cours et débuts administratifs pour l'université.
 ...
 \caption{Récapitulatif des actions à faire}
 \end{figure}
